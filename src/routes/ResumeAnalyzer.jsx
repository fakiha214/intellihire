...
const ResumeAnalyzer = () => {
  ...
  const analyzeResumes = async () => {
    ...
    if (!jobDescription.trim() && !requiredSkills.trim()) {
      setError("Please enter a job description or list the required skills")
      return
    }
    ...
    try {
      // Combine the recruiter's "ingest job" fields into one description the
      // matching model scores resumes against.
      const combinedDescription = [
        jobTitle.trim() ? `Job Title: ${jobTitle.trim()}` : "",
        jobDescription.trim(),
        requiredSkills.trim() ? `Required skills: ${requiredSkills.trim()}` : "",
      ].filter(Boolean).join("\n\n")
      ...
      formData.append("jobDescription", combinedDescription)
      ...
      <header className="bg-white shadow-sm">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Bulk CV Ranking</h1>
          </div>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            {/* Target Job */}
            <div className="bg-white rounded-lg shadow-sm p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-1">Target Job</h2>
              <p className="text-xs text-gray-500 mb-4">Describe the role you're hiring for. CVs are ranked against this.</p>
              ...
              <input
                ...
                placeholder="e.g., Python, Flask, PostgreSQL, Docker, AWS"
                className="w-full mb-4 px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500"
              />
              ...
              <button
                ...
                disabled={loading || resumes.length === 0 || (!jobDescription.trim() && !requiredSkills.trim())}
