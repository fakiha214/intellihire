...
const EventBrowsePage = ({ user }) => {
  ...
  const fetchData = async () => {
    try {
      const [eventRes, attendanceRes, jobsRes, boothsRes, applicationsRes] = await Promise.all([
        ...
        fetch(`/api/events/${eventId}/my-attendance`, { credentials: 'include' }),
        fetch(`/api/events/${eventId}/jobs`, { credentials: 'include' }),
        fetch(`/api/events/${eventId}/booths`, { credentials: 'include' }),
        fetch(`/api/events/${eventId}/my-applications`, { credentials: 'include' })
      ])
  ...
  const handleApply = async (jobId) => {
    ...
    try {
      const response = await fetch(`/api/events/${eventId}/jobs/${jobId}/apply`, {
        method: 'POST',
        credentials: 'include',
