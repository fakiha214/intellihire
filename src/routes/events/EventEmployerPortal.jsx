...
const EventEmployerPortal = () => {
  ...
  const fetchData = async () => {
    try {
      const [eventRes, profileRes, jobsRes, boothsRes] = await Promise.all([
        ...
        fetch(`http://localhost:5000/api/events/${eventId}/my-profile`, { credentials: 'include' }),
        fetch(`http://localhost:5000/api/events/${eventId}/my-jobs`, { credentials: 'include' }),
  ...
  const handleAccept = async () => {
    setSubmitting(true)
    try {
      const response = await fetch(`http://localhost:5000/api/events/${eventId}/employers/accept`, {
        method: 'POST',
        credentials: 'include'
      })
  ...
  const handleDecline = async () => {
    setSubmitting(true)
    try {
      const response = await fetch(`http://localhost:5000/api/events/${eventId}/employers/decline`, {
        method: 'POST',
        credentials: 'include'
      })
  ...
  const handleProfileSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/events/${eventId}/my-profile`, {
        method: 'PUT',
        credentials: 'include',
  ...
  const handleJobSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`http://localhost:5000/api/events/${eventId}/jobs`, {
        method: 'POST',
        credentials: 'include',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
